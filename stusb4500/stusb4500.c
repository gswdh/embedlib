...
void __attribute__((weak)) stusb_set_reset(bool en) { return; }

bool __attribute__((weak)) stusb_get_attach() { return false; }

bool __attribute__((weak)) stusb_get_nint() { return false; }

bool __attribute__((weak)) stusb_get_pok2() { return false; }

bool __attribute__((weak)) stusb_get_pok3() { return false; }
...
pdo_t stusb_read_pdo_selected() { return stusb_read_pdo(stusb_get_selected_pdo()); }
