...
// Matrix orbital
static const uint8_t dmgui_font[1280] = {
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   0
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   1
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   2
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   3
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   4
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   5
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   6
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   7
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   8
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   9
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   10
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   11
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   12
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   13
    0x00, 0x00, 0x00, 0x00, 0x00, // 0   14
...
void dmgui_add_text(char *text, uint8_t x, uint8_t y, uint8_t alignment)
{
    ...
    {
        uint32_t font_offset = (uint8_t)(text[n]) * 5;
